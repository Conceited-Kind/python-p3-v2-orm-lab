...
class Review:
    ...
    def __init__(self, year, summary, employee_id, id=None):
        self.id = id
        self.year = year  # This will use the @year.setter
        self.summary = summary  # This will use the @summary.setter
        self.employee_id = employee_id  # This will use the @employee_id.setter
